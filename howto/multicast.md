...
cs broadcasts a 48 kHz, 24-bit music stream. An SDP file is required to receive it:
```
v=0
o=- 0 0 IN IP4 172.23.199.110
s=-
i=NOP 48 kHz 24-bit music stream
e=dn42@nop.hu
c=IN IP4 232.2.3.2
...
also there is low bandwidth sap/sdp announcements of the format (samplerate could be 44.1khz, 48khz, 96khz 192khz or 384khz, bitdepts also change from 16bit, 24bit or 32bit, MSB) to 172.23.199.110,232.2.3.1:9875 that needs altering in terms of addresses embedded within, however vlc can pick it up
