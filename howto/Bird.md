...
ROA files generated by [dn42regsrv](https://git.dn42.us/burble/dn42regsrv) are available from burble.dn42:
...
*/15 * * * * curl -sfSLR -o/var/lib/bird/bird_roa_dn42.conf -z/var/lib/bird/bird_roa_dn42.conf https://dn42.burble.com/roa/n42_roa_bird1_4.conf && birdc configure
```
