...
**{{name}}.root-servers.dn42** - This server is authoritative for "." (root zone), "172.in-addr.arpa", "10.in-addr.arpa" and "d.f.ip6.arpa". Is authorative for ICANN root as well. "172.in-addr.arpa" is authorative for ICANN, except rfc1918 zones.
