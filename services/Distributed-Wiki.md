...
The local webserver is monitored with a simple shell script (below) [[working in conjunction|Distributed-Wiki#distributed-wiki-sites_exabgp]] with [ExaBGP](https://github.com/Exa-Networks/exabgp), announcing/withdrawing the assigned route if the service is up/down.  
