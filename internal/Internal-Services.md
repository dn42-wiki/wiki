...
* buzzster.dn42 runs an [asterisk based VOIP service](https://blog.jerry.dn42/dn42#Services_pbx) with shorts numbers, inbound and outbound calls and live radio. Request your short number on [KevvoGeek Telegram](https://t.me/KevvoGeek) for make and receive internal and external calls.
