...
- DN42 Explorer: [explorer.nedifinita.com](https://explorer.nedifinita.com). BGP routing, topology, and registry explorer. Provides an IPv4 interactive map, ASN connectivity, prefix status, and rankings.
### Speedtest
